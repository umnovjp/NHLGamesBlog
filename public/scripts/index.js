               ...
               for (i=0;i<data1.data.length;i++) { if (data1.data[i].typeCode===505) // goal loop
                { var whoScored ='whichTeam';
                  ...
                  // goalType5 is array of numbers by position who was on ice during the goal 
                    ...
                    else if ((goalType5[0][0].length===1)&&(goalType5[1][0].length===0)&&(goalType5[0][1].length+goalType5[0][2].length===5)&&(goalType5[1][1].length+goalType5[1][2].length===6)&&(whoScored='homeGoal')) {goalType4='homeSixOnFive'}
                    else if ((goalType5[1][0].length===1)&&(goalType5[0][0].length===0)&&(goalType5[1][1].length+goalType5[1][2].length===5)&&(goalType5[0][1].length+goalType5[0][2].length===6)&&(whoScored='awayGoal')) {goalType4='awaySixOnFive'}
                    else if ((goalType5[0][0].length===1)&&(goalType5[1][0].length===0)&&(goalType5[0][1].length+goalType5[0][2].length===5)&&(goalType5[1][1].length+goalType5[1][2].length===6)&&(whoScored='awayGoal')) {goalType4='awayEN'}
                    else if ((goalType5[1][0].length===1)&&(goalType5[0][0].length===0)&&(goalType5[1][1].length+goalType5[1][2].length===5)&&(goalType5[0][1].length+goalType5[0][2].length===6)&&(whoScored='homeGoal')) {goalType4='homeEN'}
